...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  MessageListView dco_decode_message_list_view(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 74)
      throw Exception('unexpected arr length: expect 74 but see ${arr.length}');
    return MessageListView(
      ...
      senderParticipantId: dco_decode_opt_String(arr[12]),
      senderRole: dco_decode_opt_String(arr[13]),
      category: dco_decode_String(arr[14]),
      content: dco_decode_String(arr[15]),
      status: dco_decode_String(arr[16]),
      createdAtMicros: dco_decode_i_64(arr[17]),
      mediaUrl: dco_decode_opt_String(arr[18]),
      mediaMimeType: dco_decode_opt_String(arr[19]),
      mediaSize: dco_decode_opt_box_autoadd_i_64(arr[20]),
      mediaDuration: dco_decode_String(arr[21]),
      mediaWidth: dco_decode_opt_box_autoadd_i_32(arr[22]),
      mediaHeight: dco_decode_opt_box_autoadd_i_32(arr[23]),
      thumbImage: dco_decode_opt_String(arr[24]),
      mediaStatus: dco_decode_String(arr[25]),
      quoteMessageId: dco_decode_opt_String(arr[26]),
      quoteContent: dco_decode_opt_String(arr[27]),
      quoteUserMembership: dco_decode_opt_String(arr[28]),
      caption: dco_decode_opt_String(arr[29]),
      action: dco_decode_opt_String(arr[30]),
      participantId: dco_decode_opt_String(arr[31]),
      participantFullName: dco_decode_opt_String(arr[32]),
      snapshotId: dco_decode_opt_String(arr[33]),
      snapshotType: dco_decode_opt_String(arr[34]),
      snapshotAmount: dco_decode_opt_String(arr[35]),
      snapshotMemo: dco_decode_opt_String(arr[36]),
      snapshotAssetId: dco_decode_opt_String(arr[37]),
      snapshotAssetSymbol: dco_decode_opt_String(arr[38]),
      snapshotAssetIconUrl: dco_decode_opt_String(arr[39]),
      snapshotChainIconUrl: dco_decode_opt_String(arr[40]),
      snapshotOpponentId: dco_decode_opt_String(arr[41]),
      snapshotTransactionHash: dco_decode_opt_String(arr[42]),
      snapshotCreatedAt: dco_decode_opt_String(arr[43]),
      inscriptionHash: dco_decode_opt_String(arr[44]),
      inscriptionCollectionHash: dco_decode_opt_String(arr[45]),
      inscriptionSequence: dco_decode_opt_box_autoadd_i_64(arr[46]),
      inscriptionContentType: dco_decode_opt_String(arr[47]),
      inscriptionContentUrl: dco_decode_opt_String(arr[48]),
      inscriptionName: dco_decode_opt_String(arr[49]),
      inscriptionIconUrl: dco_decode_opt_String(arr[50]),
      hyperlink: dco_decode_opt_String(arr[51]),
      mediaName: dco_decode_opt_String(arr[52]),
      albumId: dco_decode_opt_String(arr[53]),
      stickerId: dco_decode_opt_String(arr[54]),
      sharedUserId: dco_decode_opt_String(arr[55]),
      mediaWaveform: dco_decode_opt_String(arr[56]),
      thumbUrl: dco_decode_opt_String(arr[57]),
      conversationOwnerId: dco_decode_opt_String(arr[58]),
      conversationCategory: dco_decode_opt_String(arr[59]),
      sharedUserFullName: dco_decode_opt_String(arr[60]),
      sharedUserIdentityNumber: dco_decode_opt_String(arr[61]),
      sharedUserAvatarUrl: dco_decode_opt_String(arr[62]),
      sharedUserIsVerified: dco_decode_bool(arr[63]),
      sharedUserMembership: dco_decode_opt_String(arr[64]),
      sharedUserAppId: dco_decode_opt_String(arr[65]),
      stickerAssetUrl: dco_decode_opt_String(arr[66]),
      stickerAssetWidth: dco_decode_opt_box_autoadd_i_32(arr[67]),
      stickerAssetHeight: dco_decode_opt_box_autoadd_i_32(arr[68]),
      stickerAssetName: dco_decode_opt_String(arr[69]),
      stickerAssetType: dco_decode_opt_String(arr[70]),
      mentionRead: dco_decode_opt_box_autoadd_bool(arr[71]),
      pinned: dco_decode_bool(arr[72]),
      expireIn: dco_decode_opt_box_autoadd_i_64(arr[73]),
    );
  }
  ...
  MessageListView sse_decode_message_list_view(SseDeserializer deserializer) {
    ...
    var var_senderParticipantId = sse_decode_opt_String(deserializer);
    var var_senderRole = sse_decode_opt_String(deserializer);
    var var_category = sse_decode_String(deserializer);
    ...
    return MessageListView(
      ...
      senderParticipantId: var_senderParticipantId,
      senderRole: var_senderRole,
      category: var_category,
      content: var_content,
      status: var_status,
      createdAtMicros: var_createdAtMicros,
  ...
  void sse_encode_message_list_view(
    ...
    sse_encode_opt_String(self.senderParticipantId, serializer);
    sse_encode_opt_String(self.senderRole, serializer);
    sse_encode_String(self.category, serializer);
