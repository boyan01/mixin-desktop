...
class ChatSideState {
  ...
  ChatSideState copyWith({List<ConversationInfoDestination>? destinations}) =>
      ChatSideState(destinations: destinations ?? this.destinations);

  @override
  bool operator ==(Object other) =>
      other is ChatSideState && listEquals(destinations, other.destinations);
...
class ChatSideNotifier extends ValueNotifier<ChatSideState> {
  ...
  void clear() => state = state.copyWith(destinations: []);
...
class SearchConversationKeywordNotifier
  ...
  static bool _isSearchPageVisible(ChatSideState state) => state.destinations
      .contains(ConversationInfoDestination.searchMessageHistory);
  ...
  @override
  void dispose() {
    final notifier = _chatSideNotifier;
    final listener = _chatSideListener;
